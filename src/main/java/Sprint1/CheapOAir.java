...
public class CheapOAir {
	...
	//	driver.findElement(By.id("onewayTrip")).click();
		...
		driver.findElement(By.id("to0")).sendKeys("BLR");
		Thread.sleep(2000);
		...
		List<WebElement> allElements = driver.findElements(By.xpath("//div[@class='fare-details__fare focus']//span[@class='currency text-nowrap']"));
